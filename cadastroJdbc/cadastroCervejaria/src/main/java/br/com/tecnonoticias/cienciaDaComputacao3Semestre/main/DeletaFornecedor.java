...
public class DeletaFornecedor extends JFrame {
	...
	JButton bt_excluir, bt_consultar, bt_fechar;

	private JPanel contentPane;
	private static boolean fechar = true;

	public DeletaFornecedor() {

		setTitle("Exclui fornecedor");
	...
	public static void main(String[] args) {
		new DeletaFornecedor().setVisible(fechar);
	}
}