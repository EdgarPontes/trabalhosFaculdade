...
//		janela.setResizable(false);
	...
	class Selecao implements ListSelectionListener {
		...
		public void valueChanged(ListSelectionEvent e) {
			...
			int[] selRows;
			AlteraCliente altera = new AlteraCliente();
			...
			if(botaoExcluir.isSelected()){
				int[] selRows;
				DeletaCliente excluir = new DeletaCliente();
				...
				if (!e.getValueIsAdjusting()) {
					...
					if (selRows.length > 0) {
						...
						excluir.tf_Nome.setText(tm.getValueAt(selRows[0], 1).toString());
						excluir.tf_Cpf.setText(tm.getValueAt(selRows[0], 2).toString());
						excluir.tf_Rg.setText(tm.getValueAt(selRows[0], 3).toString());
						excluir.tf_Sexo.setText(tm.getValueAt(selRows[0], 4).toString());
						excluir.tf_Endereco.setText(tm.getValueAt(selRows[0], 5).toString());
						excluir.tf_Cidade.setText(tm.getValueAt(selRows[0], 6).toString());
						excluir.tf_Estado.setText(tm.getValueAt(selRows[0], 7).toString());
